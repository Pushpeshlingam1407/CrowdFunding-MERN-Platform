...
public class DocumentController {
  ...
  public ResponseEntity<?> uploadDocument(
    ...
    try {
      ...
      String userType =
        "individual".equalsIgnoreCase(role) ||
        "institutional".equalsIgnoreCase(role) ||
  ...
  public ResponseEntity<?> getDocumentsByOwner(@PathVariable Long ownerId) {
    try {
      List<Document> documents =
        documentRepository.findByUserIdOrderByCreatedAtDesc(ownerId);
      return ResponseEntity.ok(documents);
    } catch (Exception e) {
      Map<String, Object> error = new HashMap<>();
      error.put("success", false);
  ...
  public ResponseEntity<?> deleteDocument(
    ...
    try {
      ...
      if (
        !document.getUser().getId().equals(userDetails.getId()) &&
