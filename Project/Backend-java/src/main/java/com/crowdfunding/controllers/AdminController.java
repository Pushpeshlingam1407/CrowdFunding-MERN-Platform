...
public class AdminController {
  ...
  public ResponseEntity<?> getDashboardStats() {
    try {
      ...
      long approvedProjects = projectRepository
        .findAll()
        .stream()
        .filter(p -> "approved".equalsIgnoreCase(p.getStatus()))
        .count();
      long pendingProjects = projectRepository
        .findAll()
        .stream()
        .filter(p -> "pending".equalsIgnoreCase(p.getStatus()))
        .count();
      long pendingDocuments = documentRepository
        .findAll()
        .stream()
      ...
      double totalInvestedAmount = investmentRepository
        .findAll()
        .stream()
      ...
      double platformRevenue = investmentRepository
        .findAll()
        .stream()
        .filter(
          i ->
  ...
  public ResponseEntity<?> updateProjectStatus(
    ...
    try {
      ...
      if (
        status == null ||
        !Arrays.asList("pending", "approved", "rejected").contains(status)
      ) {
        Map<String, Object> error = new HashMap<>();
        error.put("success", false);
  ...
  public ResponseEntity<?> deleteUser(@PathVariable Long id) {
    try {
      ...
      complaintRepository
        ...
        .filter(
          c ->
            (c.getAuthor() != null && c.getAuthor().getId().equals(id)) ||
            (c.getTargetCompany() != null &&
              c.getTargetCompany().getId().equals(id))
        )
      ...
      reviewRepository
        ...
        .filter(
          r ->
            (r.getAuthor() != null && r.getAuthor().getId().equals(id)) ||
      ...
      investmentRepository
        ...
        .filter(
          i ->
            (i.getInvestor() != null && i.getInvestor().getId().equals(id)) ||
            (i.getProject() != null &&
              i.getProject().getCreator() != null &&
      ...
      documentRepository
        ...
        .filter(
          d ->
            (d.getUser() != null && d.getUser().getId().equals(id)) ||
      ...
      projectRepository
        ...
        .stream()
        .filter(
          p -> p.getCreator() != null && p.getCreator().getId().equals(id)
        )
