  ...
  public ResponseEntity<?> updateCompany(
    ...
    try {
      ...
      if (
        ...
        !company.getUser().getId().equals(userDetails.getId()) &&
      ...
      if (payload.containsKey("name")) company.setName(
        (String) payload.get("name")
      );
      if (payload.containsKey("logo")) company.setLogo(
        (String) payload.get("logo")
      );
      if (payload.containsKey("website")) company.setWebsite(
        (String) payload.get("website")
      );
      if (payload.containsKey("bio")) company.setBio(
        (String) payload.get("bio")
      );
      if (payload.containsKey("location")) company.setLocation(
        (String) payload.get("location")
      );
      if (payload.containsKey("foundedDate")) company.setFoundedDate(
        (String) payload.get("foundedDate")
      );
      if (payload.containsKey("teamSize")) company.setTeamSize(
        (String) payload.get("teamSize")
      );
      ...
      if (payload.containsKey("branding")) {
        ...
        if (rawBranding instanceof Map<?, ?>) {
          ...
          if (brandingMap.containsKey("logo")) branding.setBrandingLogo(
            (String) brandingMap.get("logo")
          );
          if (brandingMap.containsKey("primaryColor")) branding.setPrimaryColor(
            (String) brandingMap.get("primaryColor")
          );
          if (brandingMap.containsKey("slogan")) branding.setSlogan(
            (String) brandingMap.get("slogan")
          );
      ...
      if (payload.containsKey("visibilitySettings")) {
        ...
        if (rawVS instanceof Map<?, ?>) {
          ...
          if (vsMap.containsKey("showPortfolio")) vs.setShowPortfolio(
            (Boolean) vsMap.get("showPortfolio")
          );
          if (vsMap.containsKey("showMetrics")) vs.setShowMetrics(
            (Boolean) vsMap.get("showMetrics")
          );
          if (vsMap.containsKey("showJourney")) vs.setShowJourney(
            (Boolean) vsMap.get("showJourney")
          );
      ...
      if (payload.containsKey("socialLinks")) {
        ...
        if (rawSL instanceof Map<?, ?>) {
          ...
          if (slMap.containsKey("linkedin")) sl.setLinkedin(
            (String) slMap.get("linkedin")
          );
          if (slMap.containsKey("twitter")) sl.setTwitter(
            (String) slMap.get("twitter")
          );
          if (slMap.containsKey("github")) sl.setGithub(
            (String) slMap.get("github")
          );
        ...
        if (rawPartners instanceof java.util.Collection<?>) {
          ...
          for (Object obj : (java.util.Collection<?>) rawPartners) {
            if (obj instanceof Map<?, ?>) {
              Map<?, ?> p = (Map<?, ?>) obj;
              Long profileId =
                p.get("profileId") != null
                  ? Long.parseLong(p.get("profileId").toString())
                  : null;
              items.add(
                Company.PartnerHistoryItem.builder()
      ...
      Optional<Company> existingComp = companyRepository.findByUserId(
